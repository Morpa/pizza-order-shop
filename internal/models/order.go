...
var (
	...
	PizzaTypes    = []string{"Margherita", "Pepperoni", "Hawaiian", "Veggie", "BBQ", "Chicken",
		"Four Cheese", "Pepperoni Supreme", "Hawaiian Supreme", "Veggie Supreme", "Chicken Supreme", "Four Cheese Supreme"}
...
type OrderItem struct {
	ID           string `gorm:"primaryKey;size:14" json:"id"`
	OrderID      string `gorm:"index;size:14;not nullß" json:"orderId"`
